...
export const RoomCard: React.FC<RoomCardProps> = ({ room }) => {
  ...
  return (
    <div className="group relative bg-zinc-900 rounded-2xl border border-white/5 overflow-hidden hover:border-white/10 hover:shadow-[0_8px_30px_rgb(0,0,0,0.4)] transition-all duration-500 hover:-translate-y-1">
