        ...
        <div className="grid grid-cols-1 md:grid-cols-3 grid-rows-2 gap-6 md:h-[600px]">
          ...
          <FadeIn className="md:row-span-2 h-[400px] md:h-auto" delay={0}>
            <div className="relative w-full h-full rounded-[32px] overflow-hidden group">
              ...
              <div className="absolute top-6 left-6">
                <span className="bg-[#4a3b32] text-[#d4bca5] text-[10px] font-bold px-3 py-1.5 rounded-full tracking-wider uppercase shadow-lg">
                  Featured
                </span>
              </div>
              ...
              <div className="absolute bottom-0 left-0 p-8 w-full">
                ...
                <p className="text-zinc-300 text-sm leading-relaxed mb-6 max-w-[90%]">
                  Unwind after a hike in our exclusive lounge area featuring a
                  roaring open fire.
                </p>
          ...
          <FadeIn className="md:col-span-2 h-[300px] md:h-auto" delay={100}>
            <div className="relative w-full h-full rounded-[32px] overflow-hidden group">
              ...
              <div className="absolute top-6 left-6">
                <span className="text-white/90 text-[10px] font-bold tracking-widest uppercase mb-1 block shadow-sm">
                  The Estate
                </span>
                <h3 className="text-3xl font-serif text-white shadow-sm">
            ...
            <div className="relative w-full h-full bg-white/5 backdrop-blur-md rounded-[32px] p-8 flex flex-col justify-between border border-white/10 group hover:bg-white/10 hover:border-white/20 transition-all duration-300">
              ...
              <div>
                ...
                <p className="text-zinc-400 text-xs leading-relaxed">
                  A curated collection of rare books, maps, and local history.
                  The perfect sanctuary for a rainy afternoon by the fire.
                </p>
              </div>
            </div>
          </FadeIn>
          ...
          <FadeIn className="h-[250px] md:h-auto" delay={300}>
            <div className="relative w-full h-full rounded-[32px] overflow-hidden group">
              ...
              <div className="absolute bottom-6 left-6">
                <span className="bg-black/60 backdrop-blur-md text-white text-[10px] font-bold px-4 py-2 rounded-full tracking-wide shadow-lg border border-white/10">
                  Reading Room
                </span>
              </div>
            </div>
