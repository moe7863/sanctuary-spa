...
export const Amenities: React.FC = () => {
  return (
    <section
      id="amenities"
      className="py-24 px-6 border-y border-white/5 bg-zinc-950"
    >
        ...
        <FadeIn>
          <div className="max-w-xl mb-16">
            ...
            <p className="text-zinc-400 text-lg leading-relaxed">
              Every detail has been considered to ensure your stay is effortless
              and restorative.
            </p>
          </div>
        </FadeIn>
          ...
          >
            <div className="w-full h-full bg-zinc-900 rounded-3xl p-8 relative overflow-hidden group border border-white/5 hover:border-white/10 transition-all duration-500">
              <img
                ...
                className="absolute inset-0 w-full h-full object-cover opacity-40 group-hover:opacity-40 transition-opacity duration-700 z-0 scale-110 group-hover:scale-100"
                alt="Food"
                loading="lazy"
              />
              ...
              <div className="relative z-10 h-full flex flex-col justify-end">
                ...
                <p className="text-zinc-400 mb-8 max-w-sm group-hover:text-zinc-200 transition-colors">
                  Seasonal breakfast included with every stay, featuring
                  ingredients from our organic garden and local partners.
                </p>
                <div className="flex gap-2">
                  <span className="text-xs font-semibold px-3 py-1.5 rounded-lg bg-white/5 border border-white/10 text-zinc-300 shadow-sm">
                    Organic
                  </span>
                  <span className="text-xs font-semibold px-3 py-1.5 rounded-lg bg-white/5 border border-white/10 text-zinc-300 shadow-sm">
                    Local
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                ...
                <div className="transform translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
                  ...
                  <p className="text-zinc-300 text-sm max-w-xs">
                    Nordic sauna and cold plunge available for private booking.
                  </p>
                </div>
              </div>
            </div>
          ...
          <FadeIn className="h-[250px] md:h-auto" delay={300}>
            <div className="w-full h-full bg-zinc-900 rounded-3xl p-8 border border-white/5 flex flex-col justify-between hover:border-white/10 hover:shadow-lg transition-all duration-300 group">
              <div className="flex justify-between items-start">
                ...
                <Map
                  className="w-5 h-5 text-zinc-600 group-hover:text-emerald-500 transition-colors"
                  strokeWidth={1.5}
                />
              </div>
              <div>
                ...
                <p className="text-xs text-zinc-400 leading-relaxed">
                  Complimentary bicycles and curated trail maps.
                </p>
              </div>
            </div>
          </FadeIn>
          ...
          <FadeIn className="h-[250px] md:h-auto" delay={400}>
            <div className="w-full h-full bg-zinc-900 rounded-3xl p-8 border border-white/5 flex flex-col justify-between hover:border-white/10 hover:shadow-lg transition-all duration-300 group">
              <div className="flex justify-between items-start">
                ...
                <Zap
                  className="w-5 h-5 text-zinc-600 group-hover:text-yellow-500 transition-colors"
                  strokeWidth={1.5}
                />
              </div>
              <div>
                ...
                <p className="text-xs text-zinc-400 leading-relaxed">
                  High-speed connection throughout the property.
                </p>
              </div>
            </div>
          </FadeIn>
